		...
		html+='<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu" style="display: inline; position: absolute; top: '+top+'px; left: '+left+'px; margin-bottom: 5px; *width: 180px; z-index: 2000">';
			...
			html += '<li class="dropdown-submenu">';
				...
				html += '<ul class="dropdown-menu '+drop_down_id+'">';
					...
					html += '<li><a data-remote="true" href="#">Rhythm Guitar</a></li>';
				html += '</ul>';
			html += '</li>';
			html += '<li class="dropdown-submenu '+drop_down_id+'">';
				html += '<a data-remote="true" tabindex="-1" href="#">Drums</a>';
				html += '<ul class="dropdown-menu">';
					html += '<li><a data-remote="true" href="#">African Drums</a></li>';
					html += '<li><a data-remote="true" href="#">Drum Set</a></li>';
					html += '<li><a data-remote="true" href="#">miscellaneous</a></li>';
				html += '</ul>';
			html += '</li>';
			html += '<li class="dropdown-submenu '+drop_down_id+'">';
				html += '<a data-remote="true" tabindex="-1" href="#">Keyboard</a>';
				html += '<ul class="dropdown-menu">';
					html += '<li><a data-remote="true" tabindex="-1" href="#">Electric Keyboard</a></li>';
					html += '<li><a data-remote="true" href="#">Organ</a></li>';
					html += '<li><a data-remote="true" href="#">Piano</a></li>';
					html += '<li><a data-remote="true" href="#">Percussive</a></li>';
					html += '<li><a data-remote="true" href="#">Synth</a></li>';
				html += '</ul>';
			html += '</li>';
			html += '<li class="dropdown-submenu '+drop_down_id+'">';
				html += '<a data-remote="true" tabindex="-1" href="#">Vocals</a>';
				html += '<ul class="dropdown-menu">';
